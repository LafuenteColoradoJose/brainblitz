import { useSSRContext, ref, watchEffect, onMounted, onUnmounted, computed, mergeProps, unref, withCtx, renderSlot, createVNode, createTextVNode, toDisplayString, openBlock, createBlock, createCommentVNode, Fragment, renderList, withModifiers } from "vue";
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(_attrs)}><img src="/img/logo/logo.svg" alt="BrainBlitz" class="h-6"></div>`);
}
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (_ctx.$page.props.user.permissions.includes("read levels")) {
        ...
        _push(ssrRenderComponent(_sfc_main$2, {
          ...
          active: _ctx.route().current("levels.*")
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(` Levels `);
      ...
      if (_ctx.$page.props.user.permissions.includes("read roles")) {
        ...
        _push(ssrRenderComponent(_sfc_main$2, {
          ...
          active: _ctx.route().current("roles.*")
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(` Roles `);
      ...
      _push(`<div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600"><div class="flex items-center px-4">`);
      if (_ctx.$page.props.jetstream.managesProfilePhotos) {
