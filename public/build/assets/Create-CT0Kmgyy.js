...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({ title: "Create Level" }, _attrs), {
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h2 class="font-semibold text-xl text-[#353531] leading-tight"${_scopeId}>Create Level</h2>`);
          } else {
            return [
              createVNode("h2", { class: "font-semibold text-xl text-[#353531] leading-tight" }, "Create Level")
            ];
          }
        }),
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_sfc_main$2, {
              form: unref(form),
              onSubmit: ($event) => unref(form).post(_ctx.route("levels.store"))
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Levels/Create.vue");
