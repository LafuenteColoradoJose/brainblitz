...
import _sfc_main$2 from "./ApiTokenManager-CQjMGLNu.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ id: "root" }, _attrs))}>`);
      _push(ssrRenderComponent(_sfc_main$1, { title: "API Tokens" }, {
